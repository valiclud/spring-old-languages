...
public class OldLanguageServiceApplication {
	...
	private static final Logger LOG = LoggerFactory.getLogger(OldLanguageServiceApplication.class);

	public static void main(String[] args) {
		ConfigurableApplicationContext ctx = SpringApplication.run(OldLanguageServiceApplication.class, args);
		  ...
		  public void initIndicesAfterStartup() {
		    ...
		    IndexOperations indexOps = mongoTemplate.indexOps(OldLanguageEntity.class);
		    resolver.resolveIndexFor(OldLanguageEntity.class).forEach(e -> indexOps.createIndex(e));
		  }
		}
